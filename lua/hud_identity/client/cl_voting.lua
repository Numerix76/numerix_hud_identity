...
local function MsgDoVote(msg)
    ...
    panel.Paint = function(self, w, h)
        ...
        draw.SimpleText(DarkRP.getPhrase("time", math.Clamp(math.ceil(timeleft - (CurTime() - OldTime)), 0, 9999)), "DermaDefault", 5, 5, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    end
    function panel:Close()
        PanelNum = PanelNum - 145
...
hook.Add("DarkRPFinishedLoading", "HUD.Identity:VotingHUD", function()
    timer.Simple(1, function()
        concommand.Remove("rp_vote")
        concommand.Add("rp_vote", DoVoteAnswerQuestion)
        usermessage.Hook("KillQuestionVGUI", KillQuestionVGUI)
        usermessage.Hook("DoQuestion", MsgDoQuestion)
        usermessage.Hook("KillVoteVGUI", KillVoteVGUI)
